      ...
      <div className="flex min-h-screen items-center justify-center">
        <div className="flex flex-col items-center gap-4 text-center">
          <div className="relative">
            <div className="size-14 rounded-full border border-blue-500/20 bg-blue-500/8" />
            <Loader2 className="absolute inset-0 m-auto size-6 animate-spin text-blue-500" />
          </div>
          ...
          >
            ...
            <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
              ...
              <a
                ...
                className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 transition-colors"
              >
