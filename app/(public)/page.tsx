...
const services = [
  {
    ...
    slug: "website",
    name: "Landing Page",
    desc: "Perfect for personal brands, creators, and small businesses looking for a professional online presence.",
...

  {
    tag: "Business",
    slug: "webapp",
    name: "Business Website & App",
    desc: "Ideal for businesses that need bookings, dashboards, customer portals, or custom workflows.",
    price: "Starting at ₹25,000",
    timeline: "2–4 weeks",
    caveat: "Third-party services billed separately",
    features: [
      { text: "Secure login & data storage" },
...

  {
    ...
    desc: "Built for founders and growing businesses launching memberships, platforms, or subscription-based products.",
    price: "Starting at ₹50,000",
    timeline: "4–8 weeks",
    caveat: "Hosting & third-party services billed separately",
    features: [
...

  {
    ...
    desc: "Have a unique idea? We plan, design, and build a solution tailored specifically for your business.",
    price: "Custom pricing",
    timeline: "Depends on scope",
    caveat: "Scope & pricing finalized after a discovery call",
    features: [
      { text: "Discovery & project planning" },
      { text: "Built to grow with your business" },
      { text: "Works with your existing tools" },
      { text: "Transparent pricing & roadmap" },
    ] as Feature[],
    featured: false,
  },
];
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p className="mt-1 text-sm text-muted-foreground">
                    ...
                    subdomain so you can launch without any additional hosting
                    or domain cost.
                  </p>
                </div>
                ...
                <div className="rounded-lg border border-border/50 bg-card/40 p-4">
                  <p className="text-sm text-muted-foreground">
                    ...
                    <strong>.co</strong>, the domain registration cost is
                    separate from the project price. You&apos;ll purchase it
                    through your own account so you remain the owner, and
                    I&apos;ll handle the complete setup, SSL (HTTPS), and
